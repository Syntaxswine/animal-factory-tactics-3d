...
export const TERRAINS=['plain','forest','mountains','wetland'];
...
export function demo(){
 ...
 for(let y=0;y<HEIGHT;y++)m.sectors[y*WIDTH+7].routes.push(route('river','north','south',y%2?1/3:2/3,y%2?2/3:1/3));
