...
export function updateCliffSupports(state){for(const u of state.units){const support=rampSupportAt(state,u)||cliffSupportAt(state,u);if(support&&!u.towerPost)u.cliffSupport=support;else delete u.cliffSupport;}}
