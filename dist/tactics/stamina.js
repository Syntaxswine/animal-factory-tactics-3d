...
export function movementStamina(u,to){const distance=Math.hypot(to.x-u.x,to.y-u.y),climb=Math.abs((to.z||0)-(u.z||0));return climb?12*climb:distance*(u.stance==='prone'?3:u.running?4:u.sneaking?2:1);}
