...
export function createLadderJourney(worker,profile,event,frame,heading=0){
 ...
 climb=createLadderMotion(worker,profile,{...LADDER_PRESETS.tower,landingHandHeight:1.10,landingHandSpan:.20,...(wooden?{width:WOODEN_LADDER.width,exitWidth:WOODEN_LADDER.exitWidth,railTop:WOODEN_LADDER.railTop,railThickness:.085,railDepth:.10,rungThickness:.062,rungDepth:.082,hatch:{front:WOODEN_LADDER.z+.35-1.25,back:WOODEN_LADDER.z+.35-2.25,half:.5}}:{exitWidth:IRON_LADDER_EXIT.width})});
