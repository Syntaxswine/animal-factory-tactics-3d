...
for(const file of ['battle-3d.html','battle-3d.css','battle-3d.js','battle-renderer.js','battle-visibility.js','battle-map.js','battle-environment.js','default-factory.json'])fs.copyFileSync(new URL('dist/tactics/'+file,root),new URL('.pages-output/tactics/'+file,root));
