...
for(const file of ['editor-3d.html','editor-3d.css','editor-3d.js','editor-3d-model.js','editor-3d-camera.js','editor-3d-scene.js','battle-3d.html','battle-3d.css','battle-3d.js','battle-renderer.js','battle-visibility.js','battle-map.js','battle-environment.js','battle-motion.js','worker-locomotion.js','battle-combat.js','battle-shot-effects.js','rifle-firing.js','default-factory.json'])fs.copyFileSync(new URL('dist/tactics/'+file,root),new URL('.pages-output/tactics/'+file,root));
