...
for(const file of ['battle-3d.html','battle-3d.css','battle-3d.js','battle-renderer.js','battle-visibility.js'])fs.copyFileSync(new URL('dist/tactics/'+file,root),new URL('.pages-output/tactics/'+file,root));
