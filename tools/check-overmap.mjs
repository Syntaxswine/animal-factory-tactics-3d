...
try{
 ...
 const oldAnchor=[await page.locator('#tutorial-x').inputValue(),await page.locator('#tutorial-y').inputValue()];const oldRotation=await page.locator('#tutorial-rotation').inputValue();await page.locator('#randomize-tutorial').click();assert.notDeepEqual([await page.locator('#tutorial-x').inputValue(),await page.locator('#tutorial-y').inputValue()],oldAnchor);assert.notEqual(await page.locator('#tutorial-rotation').inputValue(),oldRotation);assert.equal(await page.locator('#tutorial-step').inputValue(),'1');await page.locator('#undo').click();assert.equal(await page.locator('#tutorial-rotation').inputValue(),oldRotation);await page.locator('#demo').click();
