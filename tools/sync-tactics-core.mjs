...
const manifest=JSON.stringify({repository:'https://github.com/Syntaxswine/animal-factory',branch:'work/mature-tree-core',revision,files:Object.fromEntries(Object.entries(files).sort())},null,2)+'\n';
