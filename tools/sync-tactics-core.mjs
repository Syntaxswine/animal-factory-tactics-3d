...
const revision='ee61884c80d50def96096d6a08488aa5d631bd67';
...
const manifest=JSON.stringify({repository:'https://github.com/Syntaxswine/animal-factory',branch:'work/movement-modes-core',revision,files:Object.fromEntries(Object.entries(files).sort())},null,2)+'\n';
