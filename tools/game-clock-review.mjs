...
try{
 ...
 const exploration=await fight();await exploration.waitForFunction(()=>battle3d.clock.minutes>=1440,{},{timeout:10000});assert.match(await exploration.locator('#game-clock').innerText(),/Day 2.*00:0/);
