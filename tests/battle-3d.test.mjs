...
test('3D simulation dependency matches the pinned modules and recorded clock adapters',()=>{
 ...
 assert.deepEqual(Object.keys(manifest.overrides),['blocks.js','connections.js','editor-model.js','engine.js','environment.js','explosives.js','inventory.js','maps.js','progression.js','projectiles.js','world.js']);
