...
Hostile review: 9/10 after changing the inner dish from chipped enamel to clean silver and improving bulb visibility. Furniture tests include footprint/resource invariants, passive world-space aim, ladder clearance and unobstructed outgoing beam direction. tools/spotlight-tower-review.mjs checks two views, browser errors and mobile overflow. Full project suite: 594 passing tests.
