...
| Large-map navigation | Minimap, overview/sector navigation and mobile pinch zoom in the new encounter UI | Next |
...
The first encounter keeps the fixed isometric camera, with pan, zoom and floor selection. Free camera rotation would also require replacing projection-based tactical overlays and reviewing wall/roof visibility from every angle.
